...
export const taskNames: Record<string, string> = {author_styles: '推荐创作风格', author_flow: '推进制作流程', author_composite: '图像合成（历史）', author_storyboard: '分镜生成', author_render: '漫剧生成', director: '剧本与分镜', art_design: '人物与场景设计', image: '生成画面', video: '生成视频', creative_watch: '编排镜头', creative_revision: '按意见修改', plan: '理解剧情想法', render: '制作过渡片段', bridge: '衔接故事', export: '导出作品'};
